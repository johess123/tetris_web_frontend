            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '80px', position: 'relative', zIndex: 1, padding: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '40px' }}>
                    ...
                    <div className="board-center" style={{ textAlign: 'center' }}>
                        ...
                        <div className="canvas-container" style={{ border: '4px solid #777', background: '#000', boxSizing: 'content-box', width: BLOCK_SIZE * GRID_WIDTH, height: BLOCK_SIZE * GRID_HEIGHT, padding: 0 }}><canvas ref={canvasRef} width={BLOCK_SIZE * GRID_WIDTH} height={BLOCK_SIZE * GRID_HEIGHT} /></div>
                    </div>
                    <div className="right-stats" style={{ width: '160px', display: 'flex', flexDirection: 'column', gap: '30px', fontFamily: '"Press Start 2P"', color: 'white' }}>
                        ...
                        <div className="stat-group">
                            ...
                            <div style={{ height: '90px', width: '120px', display: 'flex', justifyContent: 'center', alignItems: 'center', border: '1px solid #333', background: '#000', boxSizing: 'content-box' }}><canvas ref={nextCanvasRef} width="120" height="90" /></div>
                        </div>
